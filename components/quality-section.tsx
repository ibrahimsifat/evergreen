    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-[#0071BB] text-lg font-semibold mb-4">Quality Assurance</h2>
            ...
            <button className="bg-[#0071BB] hover:bg-[#005a94] text-white px-6 py-3 rounded-lg font-semibold flex items-center transition-colors shadow-lg hover:shadow-xl">
              Know More
