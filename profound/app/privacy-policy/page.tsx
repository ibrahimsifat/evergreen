              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Profound Company for Contracting ("we," "our," or "us") is
                ...
                <div className="bg-orange-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-2 text-gray-700">
                    <p>
                      <strong>Email:</strong> info@profoundksa.com
                    </p>
                    <p>
                      <strong>Phone:</strong> +966 55 211 9630
                    </p>
                    <p>
                      <strong>Address:</strong> King Abdulaziz International
                      Airport Dist., Postal Code: 23736 - Jeddah, Saudi Arabia
                    </p>
                  </div>
                </div>
              </div>
