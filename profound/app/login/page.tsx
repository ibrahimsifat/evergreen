    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="noindex, nofollow, noarchive, nosnippet"
        />
        <title>Admin Login - Profound Company for Contracting</title>
      </Head>
        ...
        <div className="max-w-md w-full space-y-8">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                <Image
                  ...
                  alt="Profound Company for Contracting"
                  width={80}
                  height={80}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder="admin@albasari.com"
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-600 mt-1">
                      Set CMS_EMAIL and CMS_PASSWORD in your .env.local file
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              © {new Date().getFullYear()} Profound Company for Contracting
