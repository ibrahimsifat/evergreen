...
# Profound Company for Contracting General Contracting EST - cPanel Deployment Script
# This script builds and prepares the project for cPanel deployment

echo "🚀 Starting deployment process for Profound Company for Contracting General Contracting EST..."
